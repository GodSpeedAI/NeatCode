...
const INSTRUCTION_FILES = [
  'AGENTS.md', 'CLAUDE.md', 'CONVENTIONS.md', 'CONTRIBUTING.md', 'CONTRIBUTING.rst',
  '.cursorrules', '.windsurfrules', 'GEMINI.md', 'engineering.md', 'ENGINEERING.md',
];

const ARCHITECTURE_FILES = [
  'ARCHITECTURE.md', 'ARCHITECTURE.rst', 'DESIGN.md', 'README.md', 'README.rst',
