...
3. **Evidence**: *What supports the claim that this is correct and complete?* Claims of correctness require verified execution. If a check was not run, it must be documented as not run ([`references/evidence.md`](../skills/neatcode/references/evidence.md)).
